...
<head>
    ...
    <title>{{ __('About Us') }} - DreamBet</title>
...
<body class="antialiased bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('about') }}" class="text-blue-600 font-medium">{{ __('About Us') }}</a>
    ...
    <section class="py-16 md:py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">{{ __('About Us') }}</h1>
            <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                    Welcome to DreamBet, your trusted platform for lottery gaming.
                </p>
                <p class="text-gray-600 mb-4">
                    This page is currently under construction. We're working hard to bring you detailed information
                    about our company, mission, and values.
                </p>
                <p class="text-gray-600 mb-4">
                    In the meantime, feel free to explore our lottery offerings or contact us if you have any questions.
                </p>
                <div class="mt-8">
                    <a href="{{ route('home') }}"
