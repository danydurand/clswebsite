    ...
    <flux:sidebar sticky stashable class="border-e border-gray-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div class="hidden lg:block px-2">
            <flux:dropdown position="top" align="start" class="w-full">
                <button class="w-full rounded-lg border border-gray-200 bg-white p-3 transition-all hover:border-blue-300 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800 dark:hover:border-blue-600">
