        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
                ...
                <div class="border-t pt-2 mt-2">
                    <a href="{{ route('lang.switch', 'en') }}"
                        class="block px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 rounded-md">{{ __('English') }}</a>
                    <a href="{{ route('lang.switch', 'es') }}"
                        class="block px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 rounded-md">{{ __('Spanish') }}</a>
                    <a href="{{ route('lang.switch', 'fr') }}"
                        class="block px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 rounded-md">{{ __('French') }}</a>
                </div>
                @auth
                    <a href="{{ url('/dashboard') }}"
